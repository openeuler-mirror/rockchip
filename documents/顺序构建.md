...
- [顺序单独构建](#顺序单独构建)
  - [准备环境](#准备环境)
  - [编译 u-boot](#编译-u-boot)
  - [构建 boot 目录](#构建-boot-目录)
  - [构建 rootfs 目录](#构建-rootfs-目录)
  - [可启动镜像构建](#可启动镜像构建)
...
**说明: 基于 build_boot.sh 提供的默认参数，执行 sudo ./build_boot.sh 可生成 Firefly-RK3399 的 boot 目录。**
...
**说明: 基于 build_rootfs.sh 提供的默认参数，执行 sudo ./build_rootfs.sh 可生成 Firefly-RK3399 的 rootfs 目录。**
